...
from sklearn.preprohttps://github.com/sohelrana-aiub/Pro/blob/main/Fish.csvcessing import  LabelEncoder
import xgboost as xgb
import numpy as np
st.header("Fish Weight Prediction App")
st.text_input("Enter your Name: ", key="name")
data = pd.read_csv("https://github.com/sohelrana-aiub/Pro/blob/main/Fish.csv")
#load label encoder
...
if st.button('Make Prediction'):
    ...
    st.write(f"Thank you for Your Time {st.session_state.name}! I hope you liked it.")
